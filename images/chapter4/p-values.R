...
measuresValidity <- function(resultFrame) {
	...
	for(dataset in datasets){
		...
		cat( wilcox.test(measuerList$resultRand, measuerList$resultJaccard)$p.value , '\n')
		cat( wilcox.test(measuerList$resultRand, measuerList$resultFM)$p.value , '\n')
		cat( wilcox.test(measuerList$resultRand, measuerList$resultVI)$p.value , '\n')
		cat( wilcox.test(measuerList$resultRand, measuerList$resultAUC)$p.value , '\n')
		
		cat( wilcox.test(measuerList$resultJaccard, measuerList$resultFM)$p.value , '\n')
		cat( wilcox.test(measuerList$resultJaccard, measuerList$resultVI)$p.value , '\n')
		cat( wilcox.test(measuerList$resultJaccard, measuerList$resultAUC)$p.value , '\n')
		
		cat( wilcox.test(measuerList$resultFM, measuerList$resultVI)$p.value , '\n')
		cat( wilcox.test(measuerList$resultFM, measuerList$resultAUC)$p.value , '\n')
		
		cat( wilcox.test(measuerList$resultVI, measuerList$resultAUC)$p.value , '\n')
